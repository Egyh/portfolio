...
const translations: Record<Language, Record<string, string>> = {
  ja: {
    ...
    "about.education": "学生時代",
    "about.educationValue": "英語を勉強していました",
    ...
    "works.project1.description":
      "Next.jsとTypeScriptで構築したモダンなポートフォリオサイト。GitHub風デザインでレスポンシブ対応とスムーズなアニメーションを実装。",
    "works.project2.title": "APIゲートウェイサービス",
    "works.project2.description":
      "認証、レート制限、包括的なログ機能を備えたマイクロサービスAPIゲートウェイ。高トラフィックアプリケーション向けに構築。",
    "works.project3.title": "クラウドインフラ構築",
    "works.project3.description":
      "自動化されたCI/CDパイプラインを備えたAWS上のスケーラブルなインフラ。コンテナオーケストレーションと監視ソリューションを含む。",
  ...
  en: {
    ...
    "hero.description":
      "Welcome to Gucchi's portfolio site. Here you'll find my projects and skills. Feel free to explore while enjoying a cup of coffee.",
    "hero.contact": "Contact",
    "about.title": "About",
    "about.subtitle": "Get to know me",
    "about.intro1":
      "I'm from Osaka. I love hot springs and camping. I'm into yuzu pepper and Japanese sweets.",
    "about.intro2":
    ...
    "works.project1.description":
      "Modern portfolio website built with Next.js and TypeScript. Features GitHub-inspired design with responsive layout and smooth animations.",
    "works.project2.title": "API Gateway Service",
    "works.project2.description":
      "Microservices API gateway with authentication, rate limiting, and comprehensive logging. Built for high-traffic applications.",
    "works.project3.title": "Cloud Infrastructure Setup",
    "works.project3.description":
      "Scalable infrastructure on AWS with automated CI/CD pipelines. Includes container orchestration and monitoring solutions.",
